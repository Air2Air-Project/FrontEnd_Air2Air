...
export default function Forecast_Page() {
  return (
    <>
      <Nav />
      <div className="bg-[url('./components/background/background.png')] bg-cover bg-opacity-50 text-white text-center rounded-t-3xl p-3 h-[83vh] flex justify-start items-center flex-col">
