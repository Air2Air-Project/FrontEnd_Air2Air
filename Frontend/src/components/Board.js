...
}, []); // 빈 배열을 의존성 배열로 사용, 컴포넌트가 처음 마운트될 때만 실행


  return (
    <>
      <div className="flex flex-col justify-center items-center">
        <div className="relative -top-44 flex flex-col items-center bg-[#17444F] text-white p-10 rounded-lg mb-8">
        ...
        <div className="bg-[#b3dcde] p-6 rounded-lg flex items-center w-1/2">
