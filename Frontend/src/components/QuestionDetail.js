  ...
  return (
    ...
    <div className="h- justify-center items-center"> 
      ...
      <div className="flex justify-between mt-8">
        <Link to="/boardlist">
          <button className="bg-gray-200 text-black py-2 px-4 rounded shadow">목록</button>
        </Link>
        <Link to="/inquiry">
          <button className="bg-[#17444F] text-white py-2 px-4 rounded shadow">1:1 문의</button>
        </Link>
      </div>
        </form>
        </div>
